...
<html lang="fr">
  <head>
    ...
    <title>Animal Crossing: New Leaf | Nicolas Moisson</title>
    <meta name="description" content="6 499 800 clochettes à rembourser, et moi, et moi, et moi...">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Animal Crossing: New Leaf | Nicolas Moisson">
    <meta name="twitter:description" content="6 499 800 clochettes à rembourser, et moi, et moi, et moi...">
    <meta name="twitter:image" content="https://nicolasmoisson.fr/img/img-grid/acnl.jpg">
    <meta name="twitter:image:alt" content="Illustration du jeu">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Animal Crossing: New Leaf | Nicolas Moisson">
    <meta property="og:description" content="6 499 800 clochettes à rembourser, et moi, et moi, et moi...">
    <meta property="og:url" content="https://nicolasmoisson.fr/textes/animalcrossingnewleaf">
    <meta property="og:image" content="https://nicolasmoisson.fr/img/img-grid/acnl.jpg">
  ...
  <body>
    ...
    <main>
      <div class="img-header">
        <picture>
          <source media="(max-width: 800px)" srcset="../img/img-header/mobile/acnl_header_800.jpg">
          <source media="(min-width: 801px)" srcset="../img/img-header/acnl_header.jpg">
          <img src="/img/img-header/#####" class="bg-img-header" alt="acnl_header.jpg"/>
        </picture>

        <h2>Animal Crossing: New Leaf</h2>
        <p>6 499 800 clochettes à rembourser, et moi, et moi, et moi...</p>
      </div>
      ...
      <article class="article" id="article">
        ...
        <audio id="audio" ontimeupdate="udpateProgress()" onended="resetAudio()" preload="none">
          ...
          <source src="../music/acnl.mp3" type="audio/mp3">
        </audio>
        <div id="audioWrap">
        ...
        <p>
          Aussi, lorsqu'il s'agit d'aborder <i>Animal Crossing&nbsp;: New Leaf</i>, je me retrouve bien embêté. Peut-on raisonnablement parler du jeu sans jamais évoquer soi-même ? Peut-on écrire sur ce jeu sans jamais inclure quelques anecdotes personnelles et quelques histoires qui nous sont arrivées en jouant à trois heures du matin, penché sur la 3DS, à fuir une tarentule rencontrée au détour d'un arbre ? Ce jeu est l'épitomé de l'anecdote, de l'histoire personnelle, du récit à la première personne. Sans le « je », sans le moi qui parcourt le village en long et en large, sans le joueur et sa vie, différente de celle d'un autre joueur à côté de lui, il n'y a pas, il ne peut pas y avoir d'<i>Animal Crossing&nbsp;: New Leaf</i>. Jeu hautement personnel s'il en est, le dernier titre dans la saga de simulation animalière invite à raconter des histoires, à partager des souvenirs, à utiliser le pronom personnel. Il ne peut en être autrement dans une œuvre qui tourne exclusivement autour de vous, autour de moi. C'est là que l'oeuvre divise et rassemble à la fois.
        </p>
        <p>
          Chacun aura ainsi une expérience différente vis-à-vis du jeu. On entend beaucoup parler de cette notion avec d'autres jeux, en disant notamment que tout le monde joue différemment, mais <i>Animal Crossing&nbsp;: New Leaf</i> est vraiment le titre qui symbolise le mieux cet aspect là du jeu vidéo. Tout, absolument tout, de la façon dont on va s'habiller, aux décisions prises envers la vie du village, en passant par l'agencement des meubles de la maison, tout renvoie ce message : il n'y a pas une mais des milliers de façon d'aborder <i>Animal Crossing</i>, autant de façons qu'il y a de joueurs.
        </p>
        <p>
          Un peu comme les <i>Sims</i> mais en plus enfantin, vais-je entendre ici et là, irrémédiablement. Oui et non. Surtout non, pour être franc. D'abord, parce que là où on s'amuse à créer un ersatz de vie dans les <i>Sims</i>, une réalité alternative mais bien ancrée dans les règles du vrai monde, pour ce qui est d'<i>Animal Crossing</i> on s'investit dans un monde complètement fantasmé, imaginé, un monde qui est littéralement comme bon nous semble, au fur et à mesure qu'on le construit, selon nos désirs et nos motivations. C'est la raison pour laquelle je n'ai jamais pu joué plus de trois heures aux <i>Sims</i>, peu importe l'édition, alors que j'ai passé presque un an jour après jour, heures après heures, saisons après saisons à vagabonder dans mon village, à la recherche d'insectes, d'habitants ou de meubles. Les <i>Sims</i> sont des jeux qui pastichent, <i>Animal Crossing</i> est un jeu qui invente.
        </p>
        <div class="img-inside">
          <img src="/img/img-inside/acnl_in.jpg" alt="Capture d'écran du jeu"/>
        </div>
        <p>
