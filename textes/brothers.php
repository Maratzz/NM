...
<html lang="fr">
  <head>
    ...
    <title>Brothers: a Tale of Two Sons | Nicolas Moisson</title>
    <meta name="description" content="Brothers : A Tale of Two Sons est une relation symbiotique entre le joueur et la manette, le jeu vidéo et le cinéma, le spectateur et l’acteur, et la frontière est fine.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Brothers: a Tale of Two Sons | Nicolas Moisson">
    <meta name="twitter:description" content="Brothers : A Tale of Two Sons est une relation symbiotique entre le joueur et la manette, le jeu vidéo et le cinéma, le spectateur et l’acteur, et la frontière est fine.">
    <meta name="twitter:image" content="https://nicolasmoisson.fr/img/img-grid/brothers.jpg">
    <meta name="twitter:image:alt" content="Capture d'écran du jeu">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Brothers: a Tale of Two Sons | Nicolas Moisson">
    <meta property="og:description" content="Brothers : A Tale of Two Sons est une relation symbiotique entre le joueur et la manette, le jeu vidéo et le cinéma, le spectateur et l’acteur, et la frontière est fine.">
    <meta property="og:url" content="https://nicolasmoisson.fr/textes/brothers">
    <meta property="og:image" content="https://nicolasmoisson.fr/img/img-grid/brothers.jpg">
...
<?php include("../components/base-texte-header-in-menu.html") ?>
    <main>
      ...
      <article class="article" id="article">
        ...
        <p>
          Survient alors le dénouement, et son utilisation intelligente du thème à travers la mécanique de jeu. En révéler plus ruinerait l’expérience du jeu mais on peut toutefois évoquer que, contrairement à beaucoup de jeux lorgnant vers le cinéma, la fin de <i>Brothers</i> n’est ni une fin purement narrative, ni cinématographique, mais une fin belle et bien principalement ludique, ancrée dans les mécanismes et les réflexes du joueur instaurés tout au long de l’expérience. Grâce à cette fin, l’œuvre s’inscrit ainsi durablement dans la lignée des jeux qui ont saisi la portée et l’importance de l’échange permanent qui s’effectue entre le joueur, la machine et l’écran, à l’instar de <i>Don’t Look Back</i> ou <i>Bioshock</i>. A défaut d’être jouable à nouveau, il est certain que l’aventure restera gravée dans la mémoire, au milieu des deux hémisphères.
        </p>
        <hr />
      </article>
      ...
      <aside class="credits" data-aos="zoom-in">
        <p>
          Brothers: A Tale of Two Sons, un jeu développé par Starbreeze Studios AB et édité par 505 Games.
        </p>
        <ul>
          <li>
          ...
          <li>
            Chef programmeur gameplay: Carl Granberg
          </li>
          <li>
            Directeur artistique: Claes Engdal
          </li>
          <li>
            Chef level designer: Filip Coulianos
          </li>
          <li>
            Musique: Gustaf Grefberg
          </li>
          <li>
            Producteur exécutif: Mikael Nermark
          </li>
          <li>
            Sorti initialement sur Xbox 360 le 7 août 2013.
          </li>
        </ul>
        <p>
          Disponible sur différentes plateformes via <a href="http://brothersthegame.com/#buy-now">le site officiel.</a>
        </p>
        <p>
          Le jeu contient des scènes choquantes et inquiétantes, du sang et possède une atmosphère parfois sombre.
        </p>
      </aside>
      <aside class="credits" data-aos="zoom-in">
        <p>
          Images de couverture et intérieures: <a href="https://www.gog.com/game/brothers_a_tale_of_two_sons">GOG.com</a>.
        </p>
      </aside>
    </main>
