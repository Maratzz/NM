...
<html lang="fr">
  <head>
    ...
    <title>Papo Y Yo | Nicolas Moisson</title>
    <meta name="description" content="Papo Y Yo est un je, mais ce n’est pas le mien, et ce ne le sera jamais.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Papo Y Yo | Nicolas Moisson">
    <meta name="twitter:description" content="Papo Y Yo est un je, mais ce n’est pas le mien, et ce ne le sera jamais.">
    <meta name="twitter:image" content="https://nicolasmoisson.fr/img/img-grid/papo_y_yo.jpg">
    <meta name="twitter:image:alt" content="Capture d'écran du jeu">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Papo Y Yo | Nicolas Moisson">
    <meta property="og:description" content="Papo Y Yo est un je, mais ce n’est pas le mien, et ce ne le sera jamais.">
    <meta property="og:url" content="https://nicolasmoisson.fr/textes/papoyyo">
    <meta property="og:image" content="https://nicolasmoisson.fr/img/img-grid/papo_y_yo.jpg">
...
<?php include("../components/base-texte-header-in-menu.html") ?>
    <main>
      <div class="img-header">
        <picture>
          <source media="(max-width: 800px)" srcset="../img/img-header/mobile/papoyyo_header_800.jpg">
          <source media="(min-width: 801px)" srcset="../img/img-header/papoyyo_header.jpg">
          <img src="../img/img-header/papoyyo_header.jpg" class="bg-img-header" alt="Image de couverture tirée du jeu"/>
        </picture>
        <h2>Papo Y Yo</h2>
        <p>Papo Y Yo est un je, mais ce n’est pas le mien, et ce ne le sera jamais.</p>
        </div>

      <article class="article" id="article">
        <h3>Publié le 10 mai 2015 - Jeux Vidéo</h3>
        <p>
          Le texte qui suit révèle des moments importants du jeu, parmi lesquels la conclusion elle-même. Je vous suggère d’avoir joué auparavant à <i>Papo Y Yo</i> avant de continuer la lecture. A vos risques et périls. Vous êtes prévenus.
        </p>
        <hr />
        <p>
          C’est devenu rare pour moi d’éprouver un sentiment fort face à une oeuvre vidéo-ludique moderne. Des sentiments, simples, oui, ils sont légions. Il y a de l’excitation, de l’énervement, de l’admiration, de la réflexion, oui. De la compassion, de l’incompréhension, de l’agacement, oui. Beaucoup de plaisir, parfois de la lassitude, pas assez d’émerveillement. Oui, tout ça est familier et récurrent. Mais un sentiment tel que celui que j’ai maintenant envers <i>Papo Y Yo</i> ? Ça ne m’était pas arrivé depuis un moment.
        </p>
        <p>
          <i>Memento Mori</i> m’avait passablement irrité, mais c’était un jeu flash anecdotique. Avec <i>Papo Y Yo</i>, on est au-delà de ça. La portée est plus grande, l’impact plus profond.
        </p>
        <p>
          Je ne passerai pas par quatre chemins: je rejette <i>Papo Y Yo</i> dans sa totalité, viscéralement, totalement, complètement. Il n’y a pas suffisamment de synonymes pour exprimer à quel point je méprise la démarche, j’invalide le jeu, je refuse le message qu’il transmet. C’est toujours triste de ne pas apprécier une oeuvre, mais quand celle-ci s’évertue tout de même à vouloir se glisser sous votre peau, malgré votre refus, ça en devient allergique. Et <i>Papo Y Yo</i> est une oeuvre qui veut absolument entrer en vous, pour vous imprégner de son misérabilisme, toucher votre corde sensible pour que l’empathie devienne apathie, purement et simplement. C’est un ver qui s’infiltre dans le cerveau et qui refuse de partir, un clou qui s’enfonce jusqu’à ce que le marteau lui-même soit également incrusté dans la chair.
        </p>
        <p>
          Le héros du jeu, Quico, est un petit garçon à la peau basanée évoluant dans un univers inspirée des favelas de l’Amérique du Sud. Le studio à l’origine de <i>Papo Y Yo</i> s’appelle Minority Media. Ça ne s’invente pas. Sur leur site internet, sobrement intitulé <i>weareminority.com</i>, on peut voir une photo (<a href="../img/minority.jpg" title="Les membres de Minority Media au moment de la sortie de Papo Y Yo">disparue depuis mais sauvegardé par mes soins</a>) de l’équipe au grand complet.
        </p>
        <p>
        ...
        <p>
          <i>Papo Y Yo</i> est un miroir, mais nous ne sommes pas devant. Vander Caballero est devant. <i>Papo Y Yo</i> est son jeu, <i>Papo Y Yo</i> est son je, le sien. Nous ne sommes pas invités dans le reflet; tout juste sommes-nous tolérés à regarder à côté, à admirer son travail. Une tape dans le dos pour lui témoigner notre soutien, et nous voilà repartis vers d’autres horizons.
        </p>
        <p>
        ...
        <p>
          C’est tout juste si <i>Papo Y Yo</i> a besoin du joueur pour fonctionner. L’oeuvre, avant d’être un jeu, est avant tout un besoin d’exorcisme pour son créateur. Il voulait sortir cela de sa poitrine; si Vander ne devait créer qu’un seul jeu dans toute sa vie, c’est celui-là.
        </p>
        <p>
          <i>Papo Y Yo</i> est un fantôme, et les fantômes sont toujours personnels.
        </p>
        <p>
        ...
        <p>
          <i>Papo Y Yo</i> a un message, mais n’a pas de jeu pour le soutenir.
        </p>
        <p>
          <i>“Ce n’est pas le jeu qui est important dans ce genre de titres.”</i>
        </p>
        <p>
        ...
        <p>
          Pourquoi <i>Papo Y Yo</i> s’acharne-t-il à présenter de la plate-formes, si les sauts sont insatisfaisants et peu techniques ? Pourquoi <i>Papo Y Yo</i> est-il rempli de puzzles, si il suffit de suivre le fil blanc pour les résoudre ? Pourquoi y a-t-il une jeune fille qu’il faut suivre, dans l’espoir de l’attraper ?
        </p>
        <p>
        ...
        <p>
          A nouveau, <i>Papo Y Yo</i> est un miroir pour Quico et Vander, mais pas pour moi. Je ne suis jamais nécessaire là-dedans, et je n’ai jamais ressenti le besoin d’y être. C’est un sentiment à la fois simple et complexe à décrire. C’est un peu de la dissonance ludo-narrative, mais à un niveau plus élevé encore.
        </p>
        <p>
        ...
        <p>
          L’exemple suivant va révéler la fin de <i>BIT.TRIP FLUX</i>, passez si vous ne voulez pas vous gâcher la surprise:
        </p>
        <p class="spoiler">
        ...
        <p>
          L’exemple suivant va révéler un moment décisif de <i>Portal</i>:
        </p>
        <p class="spoiler">
        ...
        <p>
          L’exemple qui suit révèle une scène importante de <i>Bioshock</i>:
        </p>
        <p class="spoiler">
      ...
      <aside class="credits" data-aos="zoom-in">
        <p>
          Papo Y Yo, un jeu développé et édité par Minority Media.
        </p>
        <ul>
          <li>
            Réalisation: Vander Caballero
          </li>
          <li>
        ...
        <p>
          Sorti en 2012 sur PS3 et PC.
        </p>
        <p>
          Le jeu est disponible sur <a href="http://store.steampowered.com/app/227080/Papo__Yo/">Steam</a>, entre autres.
        </p>
        <p>
          Le jeu est recommandé pour les joueurs de 12 ans et plus et contient des thèmes sensibles (violence contre les enfants, alcoolisme).
        </p>
      </aside>
      <aside class="credits" data-aos="zoom-in">
        <p>
          Images de couverture et intérieures: <a href="http://www.gameinformer.com/themes/blogs/generic/post.aspx?WeblogApp=ps3&y=2012&m=08&d=14&WeblogPostName=papo-amp-yo-review-a-triumph-of-imagination&GroupKeys=games/papo__yo/">Game Informer</a>.
        </p>
      </aside>
    </main>
