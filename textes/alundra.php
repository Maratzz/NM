...
<html lang="fr">
  <head>
    ...
    <title>Alundra | Nicolas Moisson</title>
    <meta name="description" content="Alundra est Zelda si Zelda grandissait et se concentrait un peu plus sur les Déesses que sur la princesse.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Alundra | Nicolas Moisson">
    <meta name="twitter:description" content="Alundra est Zelda si Zelda grandissait et se concentrait un peu plus sur les Déesses que sur la princesse.">
    <meta name="twitter:image" content="https://nicolasmoisson.fr/img/img-grid/alundra.jpg">
    <meta name="twitter:image:alt" content="Illustration tirée du manuel du jeu">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Alundra | Nicolas Moisson">
    <meta property="og:description" content="Alundra est Zelda si Zelda grandissait et se concentrait un peu plus sur les Déesses que sur la princesse.">
    <meta property="og:url" content="https://nicolasmoisson.fr/textes/alundra">
    <meta property="og:image" content="https://nicolasmoisson.fr/img/img-grid/alundra.jpg">
    <meta property="og:image:alt" content="Illustration tirée du manuel du jeu">
...
<?php include("../components/base-texte-header-in-menu.html") ?>
    <main>
      <div class="img-header">
        <picture>
          <source media="(max-width: 800px)" srcset="../img/img-header/mobile/alundra_header_800.jpg">
          <source media="(min-width: 801px)" srcset="../img/img-header/alundra_header.jpg">
          <img src="../img/img-header/alundra_header.jpg" class="bg-img-header" alt="Image de couverture tirée du jeu"/>
        </picture>
        <h2>Alundra</h2>
        <p>Alundra est Zelda si Zelda grandissait et se concentrait un peu plus sur les Déesses que sur la princesse.</p>
      </div>

      <article class="article" id="article">
        <h3>Publié le 8 mai 2016 - Jeux vidéo</h3>

        <audio id="audio" ontimeupdate="udpateProgress()" onended="resetAudio()" preload="none">
          <source src="../music/alundra.ogg" type="audio/ogg">
          <source src="../music/alundra.mp3" type="audio/mp3">
        </audio>
        <div id="audioWrap">
        ...
        <p>
          En soi la conclusion d’<i>Alundra</i> n’est pas bien originale et rejoint la tradition des anciens (et moins anciens) jeux qui nous amènent à rejeter le dogme religieux et défier le dieu en présence. Mais le déroulement de l’aventure et la religiosité vécue au quotidien, au milieu de tout ces drames et réflexions théologiques, font que si il est toujours question de dépeindre la religion comme un système de pensée handicapant et réducteur, le tout est largement justifié et a du sens. Il ne s’agit pas de tuer Dieu en tant que boss final. Il s’agit simplement de rendre justice et de libérer les habitants de cette chape de plomb qui leur obscurcissait la vue. Libre à eux cependant de continuer à s’engager dans des pratiques religieuses lorsque ce cauchemar sera terminé, car le monde n’est toujours pas résolu finalement, et la mort toujours aussi mystérieuse.
        </p>
        <p>
          En ce sens, <i>Alundra</i> diffère radicalement des autres jeux qui abordent ce thème. La religion n’est pas conspuée ni rejetée. Ce qui est rejeté c’est un système qui s’avère être plus oppressant que libérateur, un système devenu obsolète. Les anciennes idoles sont tombées, le Dieu prié n’est plus celui qu’on croyait. Mais le concept même de prier et d’espérer ne sera jamais remis en cause. Melzas, le Faux Dieu et antagoniste principal, l’affirme lui même à la fin du jeu, au moment de disparaître: parce que le monde sera toujours silencieux et la question de l’après-mort irrésolue, le cœur des Hommes aura toujours une part d’obscurité et de peur, inscrivant la foi et l’espérance comme éléments essentiels de la nature humaine et pérennisant ainsi le comportement religieux (peu importe le degré et l’amplitude de celui-ci). Mais ce comportement peut prendre plusieurs formes: ce peut être la foi dans la science, à l’image du sceptique Septimus; la foi dans une nouvelle religion, à l’image de la douce Yustel; la foi dans les autres à l’image du maire Beaumont; la foi dans l’avenir, à l’image d’Alundra lui-même enfin, que l’on voit repartir dans la séquence animée finale vers d’autres aventures une fois celle-ci terminée (ce qui donnera naissance à <i>Alundra 2</i>, qu’il faut fuir comme la peste cependant).
        </p>
        <div class="img-inside">
          <img src="../img/img-inside/alundra_in_2.png" alt="Capture d'écran dans une salle du donjon du désert"/>
        </div>
        <p>
          J’écris plus haut que les anciennes idoles sont tombées. Parmi elles on retrouve <i>Zelda</i>, qui phagocyte le genre de l’action-aventure plus par tradition et habitude que par réelle légitimité désormais. J’aurais bien du mal à affirmer en effet, à l’instar de certains, que la série a encore une quelconque valeur ajoutée aujourd’hui, après une traversée du désert embarrassante sur DS, un <i>Twilight Princess</i> intrigant mais paresseux et un <i>Skyward Sword</i> condescendant et irrespectueux des joueurs et joueuses.
        </p>
        <p>
          <i>Alundra</i> est un clone de <i>Zelda</i>, il est vrai, et ce constat lui a sans doute porté préjudice. Les mécaniques de jeu, la vue isométrique, le tandem exploration/donjons ont des airs de déjà-vu, mais ça s’arrête là. <i>Zelda</i> n’est jamais allé (et n’ira jamais) au-delà de sauver une princesse et jouer au héros tandis qu’<i>Alundra</i> parle de libre arbitre, de fatalité et de remise en question des dogmes religieux. Mais au-delà de ce point qui cherche la petite bête, je l’admets, <i>Zelda</i> n’ayant jamais vraiment eu la prétention d’être un grand jeu sur le plan narratif, il y a dans <i>Alundra</i> un respect de l’intelligence du joueur qu’il est difficile de retrouver désormais dans la franchise qui a laissé naître l’horrifique Fay.
        </p>
        <p>
        ...
        <p>
          Dans l’ensemble, et c’est peut-être parce que le jeu restera sans suite (oui, j’ignore volontairement l’existence d’<i>Alundra 2</i> qui n’a rien à voir avec le premier, tant dans l’histoire que dans les mécaniques de jeu), il se dégage de l’oeuvre un sentiment de découvrir quelque chose d’unique, qui ne sera jamais reproduit par la suite. Un peu comme un phare au milieu du brouillard, <i>Alundra</i> se distingue de par son histoire, son approche intime de la religion, et son traitement intelligent et respectueux des défis proposés. Oeuvre quasiment oubliée dans le patrimoine de la PS1, elle mériterait cependant d’occuper un peu plus de place sur la scène occupée par Zelda, pour toutes les raisons évoquées ci-dessus, et bien plus encore.
        </p>
        <p>
          On pourrait continuer <i>ad eternam</i> et évoquer son humour discret mais efficace, pour contrebalancer les drames et l’atmosphère sinistre; ou bien ses subtilités dans l’animation des personnages, les pas hésitants et les hochements de tête qui rajoutent des interprétations de caractère; ou bien encore ce magnifique donjon de fin, le Sanctuaire du Lac, qui est d’une beauté ludique rarement atteinte dans un jeu de ce genre, et dont l’ambiance sonore et visuelle semble être un avant-goût de la fin du monde, dans une portée eschatologique qui vient refermer la boucle religieuse de l’oeuvre. Allez, finissons là-dessus, car il ne s’agirait pas de tout révéler.
        </p>
        <blockquote>
          <i>Tel que tu étais aujourd’hui, j’ai été un jour.<br />
          Tel que je suis aujourd’hui, tu le seras un jour.<br />
          Aussi, prépare-toi à me suivre.<br /></i>
        </blockquote>
        <hr />
      </article>
      ...
      <aside class="credits" data-aos="zoom-in">
        <p>
          Alundra, un jeu développé par Matrix Software et édité par Psygnosis (EU)
        </p>
        <ul>
          <li>Réalisation: Yasuhiro Ōhori</li>
          <li>Scénario: Ichiro Tezuka</li>
          <li>Design des personnages: Yoshitaka Tamaki</li>
          <li>Musique: Kohei Tanaka</li>
          <li>Producteur exécutif: Akira Satou</li>
          <li>Producteurs: Takahiro Kaneko, Hideaki Kikukawa</li>
        </ul>
        <p>
          Sorti initialement sur PS1 en 1997.
        </p>
        <p>
          Le jeu est disponible sur les différentes consoles Playstation via le PS Store.
        </p>
        <p>
          Le jeu contient des scènes choquantes (meurtres, décès) et des éléments visuels qui peuvent déranger les personnes sensibles (épilepsie)
        </p>
      </aside>
      <aside class="credits" data-aos="zoom-in">
        <p>
          Images de couverture et intérieures: captures d'écran par moi-même.
        </p>
      </aside>
    </main>
