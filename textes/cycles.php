...
<html lang="fr">
  <head>
    ...
    <title>Cycle(s) | Nicolas Moisson</title>
    <meta name="description" content="Une histoire courte dans l'univers de World of Goo.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Cycle(s) | Nicolas Moisson">
    <meta name="twitter:description" content="Une histoire courte dans l'univers de World of Goo.">
    <meta name="twitter:image" content="https://nicolasmoisson.fr/img/img-grid/world_of_goo.jpg">
    <meta name="twitter:image:alt" content="Capture d'écran dans un niveau du jeu">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Cycle(s) | Nicolas Moisson">
    <meta property="og:description" content="Une histoire courte dans l'univers de World of Goo.">
    <meta property="og:url" content="https://nicolasmoisson.fr/textes/cycles">
    <meta property="og:image" content="https://nicolasmoisson.fr/img/img-grid/world_of_goo.jpg">
    <meta property="og:image:alt" content="Capture d'écran dans un niveau du jeu">
  ...
  <body>
    ...
    <main>
      <div class="img-header">
        <picture>
          <source media="(max-width: 800px)" srcset="../img/img-header/mobile/worldofgoo_header_800.jpg">
          <source media="(min-width: 801px)" srcset="../img/img-header/worldofgoo_header.jpg">
          <img src="/img/img-header/worldofgoo_header.jpg" class="bg-img-header" alt="Capture d'écran dans un niveau du jeu"/>
        </picture>

        <h2>Cycle(s)</h2>
        <p>Une histoire courte dans l'univers de World of Goo.</p>
      </div>

      <article class="article" id="article">
        <h3>Publié le 20 juillet 2018, écrit en 2014 - Fiction</h3>
        <h3>J'ai écrit cette histoire courte avec le morceau proposé ci-dessous en tête. Je vous recommande de l'écouter durant la lecture.</h3>

        <audio id="audio" ontimeupdate="udpateProgress()" onended="resetAudio()" preload="none">
          <source src="../music/jelly.ogg" type="audio/ogg">
          <source src="../music/jelly.mp3" type="audio/mp3">
        </audio>
        <div id="audioWrap">
      ...
      <aside class="credits" data-aos="zoom-in">
        <p>World of Goo, un jeu développé et édité par 2D Boy (Kyle Gabler et Ron Carmel)</p>
        <p>Sorti initialement en 2008 sur Windows et Wii.</p>
        <p>Disponible sur de nombreuses plateformes via <a href="https://2dboy.com/">le site internet du studio</a></p>
      </aside>

      <aside class="credits" data-aos="zoom-in">
        <p>
          Image de couverture: capture d'écran par moi-même<br />
        </p>
      </aside>
    </main>
