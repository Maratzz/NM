...
<html lang="fr">
  <head>
    ...
    <title>Alan Wake | Nicolas Moisson</title>
    <meta name="description" content="Alan Wake a beaucoup de cartes en main, hélas quand vient son tour, il tire le pouilleux.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Alan Wake | Nicolas Moisson">
    <meta name="twitter:description" content="Alan Wake a beaucoup de cartes en main, hélas quand vient son tour, il tire le pouilleux.">
    <meta name="twitter:image" content="https://nicolasmoisson.fr/img/img-grid/alanwake.png">
    <meta name="twitter:image:alt" content="Détail de la jaquette du jeu">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Alan Wake | Nicolas Moisson">
    <meta property="og:description" content="Alan Wake a beaucoup de cartes en main, hélas quand vient son tour, il tire le pouilleux.">
    <meta property="og:url" content="https://nicolasmoisson.fr/textes/alanwake">
    <meta property="og:image" content="https://nicolasmoisson.fr/img/img-grid/alanwake.png">
    <meta property="og:image:alt" content="Détail de la jaquette du jeu">
    ...
    <main>
      <div class="img-header">
        <picture>
          <source media="(max-width: 800px)" srcset="../img/img-header/mobile/alanwake_header_800.jpg">
          <source media="(min-width: 801px)" srcset="../img/img-header/alanwake_header.jpg">
          <img src="../img/img-header/alanwake_header.jpg" class="bg-img-header" alt="Image de couverture tirée du jeu"/>
        </picture>
        <h2>Alan Wake</h2>
        <p>Alan Wake a beaucoup de cartes en main, hélas quand vient son tour, il tire le pouilleux.</p>
      </div>
    <article class="article" id="article">
      <h3>Publié le 31 mai 2015 - Jeux vidéo</h3>
      <p>
        G. Féprépa écrivait dans <i>6 heures de perdues: disserter et convaincre</i> (1962, ed. Midi):
      </p>
      <blockquote>
        "Il est de bon ton de commencer toute introduction par une afin d’ouvrir au lecteur la porte de son esprit, la fenêtre de son et le grenier de ses idées reçues."
      </blockquote>
      <p>
      ...
      <p>
        Maratz repose le livre et pousse un long et profond soupir. Autant se remettre à jouer à <i>Alan Wake</i>. Le voilà désormais devant l’écran, en train de regarder Alan Wake devant un écran en train de regarder Alan Wake dans un écran en train de parler d’Alan Wake. La mise en abyme frôlait l’exploration sous-marine. Il reste là, manette en main, ne sachant pas trop quoi faire durant cette séquence où Alan Wake reste figé devant une télévision, alors que lui-même est figé devant sa télévision pour regarder Alan Wake figé devant une télévision. Il imagine qu’un être supérieur est également là, figé devant sa télévision pour le contempler faire toute cela, et la situation devient délicieusement absurde, mais fatalement redondante.
      </p>
      <p>
      ...
      <p>
        <i>“…lorsqu’on commence par citer Stephen King et Shining, pour enchaîner sur un panorama sorti tout droit de Twin Peaks, un épisode de The Twilight Zone, des hommages à John Carpenter, Evil Dead, Silent Hill, Le Seigneur des Anneaux, David Lynch et j’en passe, vous pouvez légitimement vous demander si vous n’auriez pas mieux fait de mettre un peu plus de vous dans votre pot-pourri, et un peu moins d’eux…”</i>
      </p>
      <div class="img-inside">
        <img src="../img/img-inside/alanwake_in.jpg" alt="Capture d'écran du jeu"/>
      </div>
      <p>
      ...
      <p>
        La suite, dans le <i>Gnome de Fer</i>.
      </p>
      <p>
        <a href="https://www.senscritique.com/serie/Game_of_Thrones/critique/10882936" rel="noreferrer">Slowpress</a> fait la moue et enfonce une à une les touches de sa machine à écrire. Elle tape machinalement, frustrée par la fin de cet épisode qui est comme tous les autres:
      </p>
      <blockquote>
      ...
      <p>
        <i>“Le year walking est une activité qui consiste à renier son christianisme le temps d’une nuit pour avoir accès à l’univers dans son entier et voir à travers lui l’année future. Pour cela, il faut réussir toute une série d’épreuves rituelles, à savoir:<br>
        1. S’armer jusqu’aux dents de munitions et de piles Energizer™, car la nuit est noire et pleine de terreur.<br>
        2. S’enfoncer dans la forêt, et rencontrer TON PIRE CAUCHEMAR.<br>
        3. Tourner autour de l’histoire trois fois, souffler sur la serrure de la narration et poignarder le cœur de la fiction pour avoir accès à la compréhension totale de ce meuble à tiroirs et voir l’avenir.”<br></i>
        <br>
        Extraits de <i>Le Year Walking pour les nuls</i>, Daniel Svensson, ed. Quel rapport, 1990.”<br>
      </p>
      <p>
      ...
      <blockquote>
        Que vais-je faire pour ma pauvre femme, ce personnage censé être cœur de toute cette histoire et dont nous ne saurons absolument rien jusqu’au bout, faisant tout juste office de demoiselle
        à sauver, histoire de ne jamais, ô grand jamais s’écarter une seconde des archétypes vidéoludiques?
      </blockquote>
      <p>
    ...
    <aside class="credits" data-aos="zoom-in">
      <p>
        Alan Wake, un jeu développé par Remedy Entertainement et édité par Microsoft Game Studios
      </p>
      <ul>
        <li>Scénario: Sami Järvi</li>
        <li>Directeur artistique: Saku Lehtinen</li>
        <li>Chef programmation: Olli Tervo</li>
        <li>Chef game design: Mikael Kasurinen</li>
        <li>Chef level design et environnements: Jarno Wallgrèn</li>
        <li>Producteur exécutif: Lasse Seppänen</li>
        <li>Producteur: Jyri Ranki</li>
      </ul>
      <p>
        Sorti en 2010 sur Xbox 360 puis sur PC.
      </p>
      <p>
        Le jeu contient de la violence, des scènes susceptibles de faire peur et un vocabulaire grossier.
      </p>
    </aside>
    <aside class="credits" data-aos="zoom-in">
      <p>
        Image de couverture et intérieures: <a href="http://store.steampowered.com/app/108710/Alan_Wake/">Steam</a>
      </p>
    </aside>
  </main>
