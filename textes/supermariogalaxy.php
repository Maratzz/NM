...
<html lang="fr">
  <head>
    ...
    <title>Super Mario Galaxy | Nicolas Moisson</title>
    <meta name="description" content="Super Mario Galaxy est une ligne en pointillés qui n’arrive jamais.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Super Mario Galaxy | Nicolas Moisson">
    <meta name="twitter:description" content="Super Mario Galaxy est une ligne en pointillés qui n’arrive jamais.">
    <meta name="twitter:image" content="https://nicolasmoisson.fr/img/img-grid/super_mario_galaxy.jpg">
    <meta name="twitter:image:alt" content="Illustration du jeu">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Super Mario Galaxy | Nicolas Moisson">
    <meta property="og:description" content="Super Mario Galaxy est une ligne en pointillés qui n’arrive jamais.">
    <meta property="og:url" content="https://nicolasmoisson.fr/textes/supermariogalaxy">
    <meta property="og:image" content="https://nicolasmoisson.fr/img/img-grid/super_mario_galaxy.jpg">
    <meta property="og:image:alt" content="Illustration du jeu">
...
<?php include("../components/base-texte-header-in-menu.html") ?>
    <main>
      <div class="img-header">
        <picture>
          <source media="(max-width: 800px)" srcset="../img/img-header/mobile/supermariogalaxy_header_800.jpg">
          <source media="(min-width: 801px)" srcset="../img/img-header/supermariogalaxy_header.jpg">
          <img src="../img/img-header/supermariogalaxy_header.jpg" class="bg-img-header" alt="Image de couverture tirée de la jaquette du jeu"/>
        </picture>
        <h2>Super Mario Galaxy</h2>
        <p>Super Mario Galaxy est une ligne en pointillés qui n’arrive jamais.</p>
      </div>

      <article class="article" id="article">
        <h3>Publié le 8 novembre 2016 - Jeux Vidéo</h3>

        <audio id="audio" ontimeupdate="udpateProgress()" onended="resetAudio()" preload="none">
          <source src="../music/supermariogalaxy.ogg" type="audio/ogg">
          <source src="../music/supermariogalaxy.mp3" type="audio/mp3">
        </audio>
        <div id="audioWrap">
          <button id="audioPlayer"><i class="far fa-play-circle" id="audioIcon"></i></button>
          <div>
            Gusty Garden Galaxy - Yokota, Kondo
            <progress id="seekbar" value="0" max="1"></progress>
          </div>
        </div>

        <p>
          Dans <i>The Curious Case of Benjamin Button</i> (David Fincher, 2009), il y a un personnage dénommé Mr Daws. Il apparaît régulièrement pour raconter à Benjamin comment la foudre l’a frappé sept fois tout au long de sa vie. A chaque fois que les deux hommes se rencontrent, le pensionnaire de la maison de retraite radote et mentionne ce fait remarquable, avant de détailler une des sept frappes. Benjamin, en réponse, ne dit rien et se contente de sourire. Durant la dernière scène de cette série de moments décalés et humoristiques, Mr Daws (qui n’aura pas décrit les sept frappes du reste) va au-delà du comique de répétition et explique que malgré son état de santé général et sa mémoire défaillante il est heureux d’être en vie. Dans le monologue final de Benjamin qui conclut le film, on peut voir une dernière fois un clip de Mr Daws en train d’être foudroyé, dans un ultime souvenir.
        </p>
        <p>
          Par moments, et surtout en ce moment, Nintendo me fait un peu penser à Mr Daws. Cette image est particulièrement vivace dès lors que l’entreprise annonce une nouvelle entrée dans la franchise des <i>Super Mario Bros.</i> On sent la volonté — masochiste peut-être, nostalgique assurément — de se faire frapper par un éclair de génie, tout comme cela s’était produit en 1996 pour <i>Super Mario 64</i>.
        </p>
        <p>
        ...
        <p>
          Prenez l’introduction de <i>Super Mario Galaxy</i> par exemple. Nous sommes en 2007, durant la conférence de l’E3 organisée à Santa Monica. Reggie Fils-Aimé, dont on peut légitimement penser que les mots sont représentatifs de la firme, ou tout au moins de sa branche nord-américaine, décrit le jeu en ces termes:
        </p>
        <blockquote>
          While every Mario game is a classic, in one sense, [Super Mario Galaxy] is the first worthy successor of Super Mario 64.
        </blockquote>
        <p>
          <i>“Même si tous les jeux Mario sont des classiques, dans un sens,</i> Super Mario Galaxy <i>est le premier vrai successeur de</i> Super Mario 64”.</i>
        </p>
        <p>
          Les implications de cette citation vont au-delà de la dimension marketing et promotionnelle sous-jacente. Remarquez l’enchaînement des deux adjectifs “premier” et “vrai” derrière successeur. Interrogez-vous devant l’emploi de ce mot même. Notez enfin que le jeu auquel on revient après toutes ces années est <i>Super Mario 64</i>, et non pas <i>Super Mario Sunshine</i>, sorti pourtant en 2002, soit l’entrée la plus proche lorsque <i>Galaxy</i> arrive sur le marché cette année-là.
        </p>
        <p>
          <i>Super Mario 64</i> était un éclair de génie. C’est incontestable, et plus les années passent, plus les discussions reviennent sur les mêmes sujets: comment le titre a permis de façonner la structure et la grammaire même de ce que devait être un platformer en 3D; comment sa gestion de la caméra et la non-linéarité des niveaux — mais également du centre de sélection de ceux-ci — a inspiré des centaines de développeurs; comment des séries comme <i>Kingdom Hearts</i>, <i>Banjo-Kazooie</i> ou même <i>Grand Theft Auto</i> ont toute une dette envers ce titre.
        </p>
        <p>
          <i>Super Mario 64</i> était un éclair de génie, et on comprend tout à fait pourquoi quelqu’un comme Reggie Fils-Aimé voudrait, au moment de légitimer l’arrivée de <i>Galaxy</i>, brandir le paratonnerre pour capter à nouveau de cette foudre-là. C’est comme mentionner qu’un film a été fait par les producteurs d’un autre; c’est de bonne guerre, c’est du marketing. En revanche, on a un peu plus de mal à comprendre pourquoi <i>Sunshine</i> devrait — poliment mais fermement — essuyer les plâtres de la campagne de publicité et se faire reléguer en arrière-plan. N’était-ce pas un Mario 3D majeur, dans la série des Super Mario Bros.? N’était-ce pas le Mario 3D de la GameCube, à l’instar de 64 pour la Nintendo 64 et <i>Galaxy</i> pour la Wii ?
        </p>
        <p>
          En vérité, si <i>Sunshine</i> est sacrifié sur l’autel de la postérité, c’est moins pour ses (non)qualités intrinsèques que pour la cohérence de la série au fil des générations. Grandir avec la trame historique de Mario en 3D, semble nous dire Nintendo en 2007, c’est passer de <i>Mario 64</i>, à <i>Galaxy</i>. Ha, on aimerait bien. En vérité, c’est un peu plus compliqué que cela. Grandir avec Mario ressemble plus à du polyamour qu’à de la monogamie. Il faut être capable de supporter les intrusions des autres partenaires pas forcément désirés (Yoshi, Wario, les bébés Mario et Luigi); passée la lune de miel, il faut consentir à investir dans le tennis, le golf, la course de karts ou le jeu d’ambiance; il faut enfin être capable de grandir tous ensemble au même rythme, avec le même but et les mêmes capacités, sous peine de se sentir en trop dans la relation.
        </p>
        <p>
      ...
      <aside class="credits" data-aos="zoom-in">
        <p><i>
          Super Mario Galaxy, un jeu développé et édité par Nintendo.
        </p>
        <p>
          Sorti sur Wii en 2007.
        </p>
        <ul>
          <li>Concepteur: Shigeru Miyamoto</li>
          <li>Directeur créatif & concept: Yoshiaki Koizumi</li>
          <li>Directeur créatif — conception des niveaux: Koichi Hayashida</li>
          <li>Musique: Mahito Yokota & Koji Kondo</li>
          <li>Producteurs: Shigeru Miyamoto & Takao Shimizu</li>
          <li>Producteur exécutif: Satoru Iwata</li>
        </ul>
        <p>
          Le jeu n’a pas de recommandations particulières.
        </p>
      </aside>
      <aside class="credits" data-aos="zoom-in">
        <p>
          Images de couverture: <a href="http://hdw.eweb4.com/">HDW</a>
        </p>
        <p>
          Image intérieure 1: <a href="http://nintendoenthusiast.com/blog/2015/09/08/what-makes-mario-galaxy-so-super/">Nintendo Enthusiast</a>
        </p>
        <p>
          Image intérieure 2 et 3: <a href="https://www.mariowiki.com">Wiki Mario</a>
        </p>
      </aside>
    </main>
